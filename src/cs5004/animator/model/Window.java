...
public interface Window {
     ...
     */
    void addElement(String id, int x, int y, int r, int g, int b,
...
//    void decreasePriorityToLowest(String id);
    ...
    /**
     * Generte a string representation of this window in svg format.
     * New added.
     *
     * @return
     */
    ...
    /**
     * Get all shapes in order of priority.
     * New added.
     */
