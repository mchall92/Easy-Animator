...
public class ElementImpl implements Element{
    ...
    private String[] sizeArg;
    private String posArg;
    ...
    public ElementImpl(String id, Position position, Color color,
        ...
        this.sizeArg = shape.sizeTitle().split(" ");
        this.posArg = shape.posTitle();
    }
    ...
    public ArrayList<LogNode> generateLog() {
        ...
        for (Transformation t : scaleSchedule) {
            ...
            String s = String.format("Shape %s scales from %s: %.1f, %s: %.1f to" +
                    " %s: %.1f, %s: %.1f from t=%d to t=%d", id, sizeArg[0], curr3.getFirstArg(),
                    sizeArg[1], curr3.getSecondArg(), sizeArg[0], tmp.getFirstArg(),
                    sizeArg[1], tmp.getSecondArg(), t.getFromTime(), t.getToTime());
            log.add(new LogNode(t.getFromTime(), s));
            curr3 = tmp;
        }
        return log;
    ...
    public String toString() {
        ...
        sb.append(posArg + ": " + position + ", ");
        sb.append(sizeArg[0] + ": " + size.getFirstArg() + ", ");
        sb.append(sizeArg[1] + ": " + size.getSecondArg() + ", ");
